...
function renderProgress(){
  ...
  // 🔥 IMPORTANT: numărăm maxim cât există
  let done = Object.values(day).filter(v => v).length;

  // 🛑 protecție: nu depășește total
...
window.onload=function(){ renderList(); renderCal(); renderStreak(); renderProgress(); }
